...
data class GameBoard(
    ...
    companion object {
        ...
        fun createTestMap(): GameBoard {
            ...
            board.getTile(FOREST_X1, FOREST_Y1)?.let { it.terrain = TerrainType.FOREST }
            board.getTile(FOREST_X2, FOREST_Y1)?.let { it.terrain = TerrainType.FOREST }
            board.getTile(MOUNTAIN_X1, MOUNTAIN_Y1)?.let { it.terrain = TerrainType.MOUNTAIN }
            board.getTile(MOUNTAIN_X2, MOUNTAIN_Y1)?.let { it.terrain = TerrainType.MOUNTAIN }
            board.getTile(FORT_X, FORT_Y)?.let { it.terrain = TerrainType.FORT }
