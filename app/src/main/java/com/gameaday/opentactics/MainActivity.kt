...
class MainActivity : AppCompatActivity() {
    ...
    private fun editPlayerName(profile: PlayerProfile) {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Save") { _, _ ->
                val newName = input.text.toString().trim().ifEmpty { "Player" }
    ...
    private fun toggleSetting(profile: PlayerProfile, setting: String) {
        val preferences = profile.preferences
    ...
    private fun startGame(saveId: String? = null, playerName: String, isNewGame: Boolean) {
